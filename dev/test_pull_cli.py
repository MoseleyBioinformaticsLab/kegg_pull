...
test_main_single_data = [
    (
        ...
        {'output': '.', 'entry_field': None, 'multiprocess_lock_save': False}
    ),
    (
        ['--entry-ids=1,2', '--output=out-dir/', '--sleep-time=10.1'],
        {'n_tries': None, 'time_out': None, 'sleep_time': 10.1},
        {'output': 'out-dir/', 'entry_field': None, 'multiprocess_lock_save': False}
    ),
    (
        ['--entry-ids=1,2', '--n-tries=4', '--time-out=50', '--entry-field=mol'],
        {'n_tries': 4, 'time_out': 50, 'sleep_time': None}, {'output': '.', 'entry_field': 'mol', 'multiprocess_lock_save': False}
    )
]
...
test_main_multiple_data = [
    (
        ...
        {'output': '.', 'entry_field': 'mol', 'multiprocess_lock_save': False}, 'from_file', {'file_path': 'entry-ids.txt'},
    ...
    (
        ...
        {'output': 'out-dir', 'entry_field': None, 'multiprocess_lock_save': False}, 'from_database', {'database_name': 'pathway'},
    ...
    (
        ...
        {'n_tries': 5, 'time_out': 35, 'sleep_time': None}, {'output': '.', 'entry_field': None, 'multiprocess_lock_save': False}, 'from_database',
    ...
    (
        ...
        {'output': '.', 'entry_field': None, 'multiprocess_lock_save': False}, 'from_file', {'file_path': 'entry-ids.txt'},
