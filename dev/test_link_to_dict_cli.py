...
# TODO complete
# @pt.mark.parametrize('args,method,kwargs,stdin_mock', test_main_data)
# def test_main_file(mocker, args: list, method: str, kwargs: dict, stdin_mock: str):
#     u.test_main_file(mocker, argv_mock=args, output_file=output)