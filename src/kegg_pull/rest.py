...
class KEGGrest:
    ...
    def list(self, database: str) -> KEGGresponse:
        ...
        :param database: The name of the database from which to pull entry IDs.
        :return: The KEGG response.
        """
    ...
    def info(self, database: str) -> KEGGresponse:
        ...
        :param database: The name of the database to pull information about.
        :return: The KEGG response
        """
    ...
    def database_link(self, target_database: str, source_database: str) -> KEGGresponse:
        """ Executes the "link" KEGG API operation, showing the IDs of entries in one database that are connected/related to entries of another database.

        :param target_database: One of the two databases from which to pull IDs of linked entries.
        :param source_database: The other database to link entries to the target database.
        :return: The KEGG response
        """
        return self.request(
    ...
    def entries_link(self, target_database: str, entry_ids: list) -> KEGGresponse:
        ...
        :param target_database: The database to find links to the provided entries.
