...
Options:
    ...
    <database>              The name of the KEGG database from which to pull a list of entry IDs.
    ...
    molec-attr              Short for molecular attribute. Searches a database of molecule-type KEGG entries by molecular attributes.
