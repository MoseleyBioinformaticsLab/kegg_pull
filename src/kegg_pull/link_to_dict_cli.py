...
Usage:
    ...
    kegg_pull link-to-dict reaction-to-compound [--add-glycans] [--add-drugs] [--output=<output>]
    kegg_pull link-to-dict gene-to-compound [--add-glycans] [--add-drugs] [--output=<output>]
    kegg_pull link-to-dict compound-to-pathway [--add-glycans] [--add-drugs] [--output=<output>]
    kegg_pull link-to-dict compound-to-reaction [--add-glycans] [--add-drugs] [--output=<output>]
    kegg_pull link-to-dict compound-to-gene [--add-glycans] [--add-drugs] [--output=<output>]
